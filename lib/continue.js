...
var func_length_n = function(n, func) {
  // black magic !!! help me, if you have better idea
  switch (n) {
...
var C_proto = {
  ...
  assign2: function() {
    ...
    return func_length_n(keys.length / 2, func);
  },
  get fail () {
    return function(err) {
...
var Block_proto = {
  ...
  constructor: function () {
    var obj = function() {
      obj._invoke.invoke(this, arguments);
    };
  ...
  then: function(func) {
    ...
    this.invoke = function(locals) {
      if (locals.err != undefined && !silent) {
        throw locals.err;
      }
      if (func) {
        var args = [];
